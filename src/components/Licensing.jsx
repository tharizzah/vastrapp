    ...
    >
      <div className="center col">
        <img
          className="image"
          src={atsymbol}
          alt="Your Complete Music Licensing Solution"
          style={{ opacity: 0 }}
        ...
        <p>
          ...
          payments and create custom licensing agreements. Whether you&#x27;re
          releasing a single or managing an entire catalog, our platform
          provides the flexibility, speed, and control you need.
        </p>
      </div>
