        ...
        <div className="space-between stretch _10p">
          ...
          <div className="div-grow">
            ...
            <p>
              ...
              infrastructure. The Marketplace of origin takes a fee, and the
              remaining amount goes to the artist.
            </p>
          </div>
        </div>
        <div className="space-between stretch _10p">
        ...
        <div className="space-between stretch _10p">
          ...
          <div className="div-grow">
            ...
            <p>
              ...
              royalties. Clear and present DMCA take down protocol protects
              asset holders.
            </p>
          </div>
        </div>
        ...
        <div className="space-between stretch _10p">
          <div>
            <img
              ...
              alt="VASTR's Support for Charitable Donations"
              className="image"
            />
          </div>
          <div className="spacer"></div>
